...
describe('sls-basic', async () => {
  const folder = await getTestProjectFolder('sls-basic');
  ...
  test('check infra', async () => {
    const lambdaName = 'lls-sls-basic-test-testJsCommonJs';
  ...
  test('call Lambda - testJsEsModule', async () => {
    const lambdaName = 'lls-sls-basic-test-testJsEsModule';
