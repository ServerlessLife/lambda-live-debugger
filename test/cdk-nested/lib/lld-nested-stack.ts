...
import { LLDNestedNestedStack } from './lld-nested-nested-stack';

export class LLDNestedStack extends NestedStack {
  constructor(scope: Construct, id: string, props?: NestedStackProps) {
    super(scope, id, props);

    new LLDNestedNestedStack(this, 'nested-nested-stack');
    ...
    new CfnOutput(this.nestedStackParent!, 'FunctionNameTestTsCommonJs', {
      value: functionTestTsCommonJs.functionName,
    });

    new CfnOutput(this.nestedStackParent!, 'FunctionNameTestTsEsModule', {
      value: functionTestTsEsModule.functionName,
    });

    new CfnOutput(this.nestedStackParent!, 'FunctionNameTestJsCommonJs', {
